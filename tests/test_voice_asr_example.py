...
def test_m5_activation_capture_records_high_power_without_thermal_warning() -> None:
    capture = json.loads(
        (EXAMPLE / "raw" / "parakeet-tdt-06b-v3-fp16-mlx-m5-asr-activation-v1.json").read_text(
            encoding="utf-8"
        )
    )
