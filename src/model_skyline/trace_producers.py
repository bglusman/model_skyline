...
_CLAUDE_CODE_LICENSE = "https://github.com/anthropics/claude-code/blob/v2.1.220/LICENSE.md"
_HERMES_LICENSE = (
...
_register(
    TrustedTraceProducer(
        ...
        source=_source(
            ...
            methodology=(
                "Exact Claude Code 2.1.220 terminal-result union and aggregate usage serializer "
                "reviewed from the installed native release identified by its embedded build "
                "SHA; official headless-mode documentation independently describes total and "
                "per-model cost output. The adapter accepts only that version and build identity."
            ),
